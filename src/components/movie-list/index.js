...
const renderList = (list, nowShowing = true) => (
  list.map((item, index) => <div key={index}>
    {RenderMovieCard(item, nowShowing)}
  </div>
  )
)
...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className={className}
      style={{ ...style, display: "block", background: "#0000002f", borderRadius: '50%' }}
      onClick={onClick}
    />
  );
}
...
const list = [
  {
    ...
    "hinhAnh": "http://movie0706.cybersoft.edu.vn/hinhanh/lua-deu-gap-lua-dao_gp02.jpg",
  ...
  },
  {
    ...
    "hinhAnh": "http://movie0706.cybersoft.edu.vn/hinhanh/chi-muoi-ba-ba-ngay-sinh-tu_gp02.jpg",
  ...
  },
  {
    ...
    "hinhAnh": "http://movie0706.cybersoft.edu.vn/hinhanh/avengers-cuoc-chien-vo-cuc1_gp02.jpg",
  ...
  },
  {
    ...
    "hinhAnh": "http://movie0706.cybersoft.edu.vn/hinhanh/death-stranding_gp02.jpg",
